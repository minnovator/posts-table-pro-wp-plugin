...
class Settings_Util
{
    ...
    {
        $links = \apply_filters('barn2_plugins_title_links', ['doc' => ['url' => $plugin->get_documentation_url(), 'label' => __('Documentation', 'posts-table-pro'), 'target' => '_blank'], 'support' => ['url' => $plugin->get_support_url(), 'label' => __('Support', 'posts-table-pro'), 'target' => '_blank']], $plugin);
