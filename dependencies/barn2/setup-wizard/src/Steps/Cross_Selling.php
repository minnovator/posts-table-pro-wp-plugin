...
class Cross_Selling extends Step
{
    ...
    {
        $this->set_id('more');
        $this->set_name(esc_html__('More', 'posts-table-pro'));
        $this->set_title(esc_html__('Extra features', 'posts-table-pro'));
        $this->set_description(esc_html__('Enhance your site with these fantastic plugins from Barn2.', 'posts-table-pro'));
    }
    /**
     * {@inheritdoc}
     */
