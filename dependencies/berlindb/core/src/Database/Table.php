...
abstract class Table extends Base
{
    ...
    {
        return (bool) (\defined('Barn2\\Plugin\\Posts_Table_Pro\\Dependencies\\WP_TESTS_DIR') && WP_TESTS_DIR) || \function_exists('Barn2\\Plugin\\Posts_Table_Pro\\Dependencies\\_manually_load_plugin');
    }
    /**
