	...
	public static function column_defaults() {
		...
		if ( empty( self::$column_defaults ) ) {
			...
			self::$column_defaults = apply_filters(
				'posts_table_column_defaults',
				[
					'id'            => [
						'heading'  => __( 'ID', 'posts-table-pro' ),
						'priority' => 3
					],
					'title'         => [
						'heading'  => __( 'Title', 'posts-table-pro' ),
						'priority' => 1
					],
					'content'       => [
						'heading'  => __( 'Content', 'posts-table-pro' ),
						'priority' => 8
					],
					'excerpt'       => [
						'heading'  => __( 'Summary', 'posts-table-pro' ),
						'priority' => 4
					],
					'date'          => [
						'heading'  => __( 'Date', 'posts-table-pro' ),
						'priority' => 5
					],
					'date_modified' => [
						'heading'  => __( 'Last Modified', 'posts-table-pro' ),
						'priority' => 5
					],
					'author'        => [
						'heading'  => __( 'Author', 'posts-table-pro' ),
						'priority' => 9
					],
					'categories'    => [
						'heading'  => __( 'Categories', 'posts-table-pro' ),
						'priority' => 6
					],
					'tags'          => [
						'heading'  => __( 'Tags', 'posts-table-pro' ),
						'priority' => 10
					],
					'status'        => [
						'heading'  => __( 'Status', 'posts-table-pro' ),
						'priority' => 11
					],
					'image'         => [
						'heading'  => __( 'Image', 'posts-table-pro' ),
						'priority' => 2
					],
					'button'        => [
						'heading'  => '',
