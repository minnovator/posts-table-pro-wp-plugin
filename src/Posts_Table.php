...
use Barn2\Plugin\Posts_Table_Pro\Data\Data_Factory;
use Barn2\Plugin\Posts_Table_Pro\Util\Columns_Util;
use Barn2\Plugin\Posts_Table_Pro\Util\Util;
use Barn2\Plugin\Posts_Table_Pro\Dependencies\Lib\Table\Html_Data_Table;
...
class Posts_Table {
	...
	public function update( array $args ) {
		...
		$post_selection_args   = apply_filters( 'posts_table_update_post_selection_args', [
			'post_type',
			'status',
			'year',
			'month',
